...
`;e.ShadersStore[p]||(e.ShadersStore[p]=m);var h=[d,i,a,f,n,o,s,t,u,r,c,l];for(let t of h)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var g={name:p,shader:m};export{g as gaussianSplattingVertexShader};