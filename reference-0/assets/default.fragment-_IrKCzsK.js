import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./helperFunctions-BH8P-eyq.js";import{t as n}from"./fresnelFunction-BmNPQIdN.js";import{n as r,t as i}from"./sceneUboDeclaration-C_WIasrC.js";import{t as a}from"./decalFragment-CvBK6CMD.js";import{t as o}from"./defaultUboDeclaration-L84hU6Ww.js";import{_ as s,a as c,b as l,c as u,d,f,g as p,h as m,i as h,l as g,m as _,n as v,o as y,p as b,r as x,s as S,t as C,u as w,v as T,y as E}from"./oitFragment-DVRlJ2kO.js";import{n as D,t as O}from"./logDepthDeclaration-BYs2zDV7.js";import{n as k,t as A}from"./clipPlaneFragment-Ct2VqHzk.js";var j=`clusteredLightingCompute`,M=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var N={name:j,shader:M},P=`lightsFragmentFunctions`,F=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var I={name:P,shader:F},L=`defaultPixelShader`,R=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[L]||(e.ShadersStoreWGSL[L]=R);var z=[i,r,o,l,E,D,t,T,s,p,N,I,m,_,n,b,f,d,w,g,u,k,O,S,A,y,a,c,h,x,v,C];for(let t of z)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var B={name:L,shader:R};export{B as defaultPixelShaderWGSL};