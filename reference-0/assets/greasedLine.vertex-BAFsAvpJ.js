import{t as e}from"./shaderStore-D-XQlhUT.js";import{L as t,X as n}from"./index-CJPsO_Vx.js";var r=`greasedLineVertexShader`,i=`precision highp float;
...
`;e.ShadersStore[r]||(e.ShadersStore[r]=i);var a=[n,t];for(let t of a)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var o={name:r,shader:i};export{o as greasedLineVertexShader};