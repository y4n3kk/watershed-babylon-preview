...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);var te={name:v,shader:y},b=`reflectionFunction`,x=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=x);var S={name:b,shader:x},C=`imageProcessingDeclaration`,w=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var P={name:M,shader:N},F=`bumpFragmentFunctions`,I=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var ne={name:F,shader:I},L=`fogFragmentDeclaration`,R=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=R);var re={name:L,shader:R},z=`bumpFragment`,B=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=K);var q={name:G,shader:K},J=`logDepthFragment`,Y=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var ie={name:J,shader:Y},X=`fogFragment`,Z=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var ae={name:X,shader:Z},Q=`oitFragment`,$=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[Q]||(e.IncludesShadersStoreWGSL[Q]=$);var oe={name:Q,shader:$};export{f as _,W as a,r as b,ne as c,O as d,T as f,ee as g,_ as h,q as i,P as l,te as m,ae as n,V as o,S as p,ie as r,re as s,oe as t,j as u,l as v,o as y};